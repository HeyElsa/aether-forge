...
<video src="/videos/06-memory.mp4" poster="/video-posters/06-memory.jpg" aria-label="Aether Forge documentation video" controls playsInline style={{width:'100%',aspectRatio:'16/9',background:'#0a0a0a',borderRadius:12,marginTop:16,marginBottom:16,display:'block'}} preload="none" />
...
forge run ./my-agent --environment sandbox --mode paper

# With knowledge layer (all 4 layers)
forge run ./my-agent --environment sandbox --mode paper --knowledge
```
