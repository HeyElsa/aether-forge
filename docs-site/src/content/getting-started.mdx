...
<video src="/videos/31-getting-started.mp4" poster="/video-posters/31-getting-started.jpg" aria-label="Aether Forge documentation video" controls playsInline style={{width:'100%',aspectRatio:'16/9',background:'#0a0a0a',borderRadius:12,marginTop:16,marginBottom:16,display:'block'}} preload="none" />

Want the shortest possible path? Use [First 10 Minutes](/docs/guides/first-10-minutes). Need help choosing an install or feature guide? Use [Choose Your Path](/docs/guides/choose-your-path).
...
- [First 10 Minutes](/docs/guides/first-10-minutes) — shortest safe path from shell to one completed tick
- [Choose Your Path](/docs/guides/choose-your-path) — pick the right guide for your goal
- [Install Matrix](/docs/reference/install-matrix) — install only the extras your agent needs
- [Generated Agent Anatomy](/docs/reference/generated-agent-anatomy) — understand every file `forge generate-fast` creates
