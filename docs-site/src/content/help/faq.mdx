...
See [CONTRIBUTING.md](https://github.com/HeyElsa/aether-forge/blob/main/CONTRIBUTING.md). Tests must pass: `pytest tests/ -x`.
...
Email `x402@heyelsa.ai`. Don't open public issues for vulnerabilities.
