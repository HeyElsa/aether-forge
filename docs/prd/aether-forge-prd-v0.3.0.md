...
Supersedes: `docs/prd/aether-forge-prd-v0.2.0.md`
...
### 7.7 Self-evolution remains governed
...
Goal:
Prove that slow mode materially improves outputs and produces useful research records.
...
6. The product sounds like a generic agent builder instead of a governed agent engineering system.
