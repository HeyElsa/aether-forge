...
Supersedes: `docs/prd/aether-forge-prd-v0.4.0.md`
Supporting research:
...
This version strengthens the product by tightening the requirement contract rather than changing the product direction. The biggest upgrades are:

- clearer artifact ownership
- stricter slow-mode comparison rules
- stronger runtime and policy evidence contracts
- more explicit evaluation, promotion, rollout, and incident requirements
...
### 7.11 Self-evolution remains governed
...
- `Capability Manifest` owns executable access inventory, provider constraints, and approval metadata
...
### 16.5 Availability And Effect Linkage
...
Goal:
Prove that ideas can become typed specs and credible scaffolds quickly, with explicit artifact ownership and validation.
